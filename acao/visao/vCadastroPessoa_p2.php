          ...
          <ul><li><a href="" target="_parent">Programas</a></li></ul>
                            ...
                            <div class="bloco">
                              ...
                              <div style="margin: 10px; border: #b1b1b1 solid 2px;"> 
                                      ...
                                      <p>Nome completo:                                      </p>
                                      <p>
                                        <input type="text" name="nome" size="30" value="" disabled />
                                      </p>
                                    <p><br />
                                        CPF:</p>
                                    <p>
  <input type="text" name="cpf" size="12" value="" disabled/>
                                    </p>
                                    <p>&nbsp;</p>
                                    <p>RG:                                      </p>
                                    <p>
                                      <input type="text" name="rg"value="" size="14" disabled/>
                                    </p>
                                    <p>&nbsp;</p>
                                    Sexo: <select name="sexo" disabled>
...
<p>Telefone:</p>
                                        <p>
                                          <input maxlength="15" name="telefone" size="15" disabled />
                                          <input type="checkbox" id="telefone2" onclick="novoTelefone()"/>
                                          Adicionar outro telefone</p>
  <div style="margin: 10px 0px 0px 0px;  display: none;" id="novoTelefone" > <input maxlength="15" disabled name="telefone2" size="15"/></div>
                                        <p>&nbsp;</p>
<p>Data de nascimento:              </p>
<p>
    <input maxlength="10" name="dataNascimento" size="9" disabled onblur="validaData(this,this.value)" onkeypress="Data(event,this)"/></p>
                                      </div>
                              </div>
                                                        <br/>
                                                        <div style="margin: 10px; border: #b1b1b1 solid 2px;">
                                                            ...
                                                            <p>&nbsp;</p>
                                                            <p>Logradouro: <br/>
                                                            <input type="text" name="logradouro" size="30" value=""  />
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            <p>Número:<br/>

                                                            <input type="text" name="numero" size="12" value="" />
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            <p>Cidade:<br/>

                                                            <input type="text" name="cidade" value="" size="14" />
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            <p>Bairro: <br/>
                                                            <input type="text" name="bairro" value="" size="14" />
                                                            </p>
                                                            <p>&nbsp;</p>

                                                            <p>CEP:<br/>
  <input type="text" name="cep" value="" size="14" />
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            <p>Estado:<br/>

    <input type="text" name="estado" value="" size="14" /><br/><br/>
...
<!--
                                                                                                          ...
                                                                                                          <center>
                                      <p>
                                      <input type="submit" class="button blue" value="Cadastrar"/>
                                      </p>
                                    </center>
                                                                                                                            </form>
                          </div>
